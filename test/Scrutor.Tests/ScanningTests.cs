...
namespace Scrutor.Tests
{
    ...
    public class ScanningTests : TestBase
    {
        ...
        public void ThrowsOnWrongInheritance()
        {
            ...
            Assert.Equal(@"Type ""Elsa.Scrutor.Tests.WrongInheritance"" is not assignable to ""Elsa.Scrutor.Tests.IWrongInheritanceA"".", ex.Message);
        }
        ...
        public void ThrowsOnDuplicate()
        {
            ...
            Assert.Equal(@"Type ""Elsa.Scrutor.Tests.DuplicateInheritance"" has multiple ServiceDescriptor attributes with the same service type.", ex.Message);
        }
